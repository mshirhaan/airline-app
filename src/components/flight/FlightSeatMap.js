...
class FlightSeatMap extends React.Component {
  ...
  render() {
    return (
      <>
        <h1 style={{ textAlign: "center" }}>Seat Map</h1>
        <div className="foo checkedIn"></div>{" "}
        <h4 style={{ textAlign: "left" }}>Checked In</h4>
        <div className="foo notCheckedIn"></div>{" "}
        <h4 style={{ textAlign: "left" }}>Not checked In</h4>
        <div className="foo notBooked"></div>{" "}
        <h4 style={{ textAlign: "left" }}>Not Booked</h4>
                      ...
                      return (
                        <li key={flightSeat.seatNumber} className="seat">
                          <input
                            ...
                            defaultChecked={flightSeat.isCheckedIn}
